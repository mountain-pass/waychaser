...
//   `'BROWSER_PORT' environment variable must be set`
// );
export var BROWSER_PORT = Number.parseInt(process.env.BROWSER_PORT);

assert(process.env.API_PORT, `'API_PORT' environment variable must be set`);
export var API_PORT = Number.parseInt(process.env.API_PORT);
