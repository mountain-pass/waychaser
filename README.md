...
[![npm package vulnerabilties](https://img.shields.io/snyk/vulnerabilities/npm/@mountainpass/waychaser@1.38.0?label=npm%20package%20vulnerabilties)](https://snyk.io/test/npm/@mountainpass/waychaser/1.38.0) [![npm package dependencies](https://img.shields.io/librariesio/release/npm/@mountainpass/waychaser/1.38.0)](https://libraries.io/npm/@mountainpass/waychaser/1.38.0)
...
```html
<script type="text/javascript" src="https://unpkg.com/@mountainpass/waychaser@1.38.0"></script>
